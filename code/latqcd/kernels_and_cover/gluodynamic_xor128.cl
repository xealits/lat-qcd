...
// 3-rd component
//#define TMATRIXDEFINITION double2 expposxi = (double2)(cos(flux/2.0), sin(flux/2.0)); double2 expnegxi = (double2)(cos(flux/2.0),-sin(flux/2.0)); T.a00 = expposxi; T.a11=expnegxi;

// 8-th component
#define TMATRIXDEFINITION double2 exp00 = (double2)(cos(flux/(2.0*SQRT3)), sin(flux/(2.0*SQRT3))); double2 exp11 = (double2)(cos(flux/(2.0*SQRT3)), sin(flux/(2.0*SQRT3))); double2 exp22 = (double2)(cos(flux/(SQRT3)),-sin(flux/(SQRT3))); T.a00 = exp00; T.a11=exp11; T.a22=exp22;
...
/*
	...
	double2 exp00 = (double2)(cos(flux/(2.0*SQRT3)), sin(flux/(2.0*SQRT3)));
        double2 exp11 = (double2)(cos(flux/(2.0*SQRT3)), sin(flux/(2.0*SQRT3)));
        double2 exp22 = (double2)(cos(flux/(SQRT3)),-sin(flux/(SQRT3)));
	T.a00 = exp00; T.a11=exp11; T.a22=exp22;
*/
...
//#include "dirak_matr_mul.cl"
//#include "scalar_mul.cl"
